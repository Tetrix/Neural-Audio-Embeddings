...
class Decoder(nn.Module):
    def __init__(self, encoder_hidden_size, decoder_hidden_size, num_layers, encoder_num_layers, batch_size):
        ...
        self.lstm = nn.LSTM(self.encoder_hidden_size + 40,
    ...
    def forward(self, encoder_output, input_tensor, decoder_hidden, attn_weights):
        ...
        return decoder_output, decoder_hidden, attn_weights.permute(1, 2, 0)
